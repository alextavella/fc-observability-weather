...
type Config struct {
	APP_A_PORT      int    `mapstructure:"APP_A_PORT"`
	APP_A_HOST      string `mapstructure:"APP_A_HOST"`
	APP_B_PORT      int    `mapstructure:"APP_B_PORT"`
...
func NewConfig(path, name string) (*Config, error) {
	...
	fmt.Printf("APP_A_PORT: %d\n", cfg.APP_A_PORT)
	fmt.Printf("APP_A_HOST: %s\n", cfg.APP_A_HOST)
	fmt.Printf("APP_B_PORT: %d\n", cfg.APP_B_PORT)
	fmt.Printf("APP_B_HOST: %s\n", cfg.APP_B_HOST)
	fmt.Printf("OTEL_HOST: %s\n", cfg.OTEL_HOST)
	fmt.Printf("WEATHER_API_KEY: %s\n", cfg.WEATHER_API_KEY)
